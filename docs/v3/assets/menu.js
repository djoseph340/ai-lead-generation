    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom sticky-top">
      <div class="container-lg">
        <a class="navbar-brand fw-bold" href="${basePath}index.html">
          <span style="color: #667eea;">NextGen</span>LeadGen <span style="font-size: 0.8rem; background: #ff922b; color: white; padding: 2px 8px; border-radius: 4px; margin-left: 8px;">v3</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link ${currentPage === 'architecture' ? 'active' : ''}" href="${basePath}pages/architecture.html">Architecture</a>
            </li>
            <li class="nav-item">
              <a class="nav-link ${currentPage === 'ai-agents' ? 'active' : ''}" href="${basePath}pages/ai-agents.html">AI Agents</a>
            </li>
            <li class="nav-item">
              <a class="nav-link ${currentPage === 'enrichment' ? 'active' : ''}" href="${basePath}pages/enrichment.html">Enrichment</a>
            </li>
            <li class="nav-item">
              <a class="nav-link ${currentPage === 'rag' ? 'active' : ''}" href="${basePath}pages/rag.html">RAG</a>
            </li>
            <li class="nav-item">
